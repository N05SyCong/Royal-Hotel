    ...
    <div class="container-1">
        ...
        <div class="show">
            <div class="container-show">
                <div class="row1">
                    <ul class="ul-show">
                        <li><img  id="wifi" width="40" src="assets/images/wifi.png"><p id="p1">FREE WIFI </br><h id="h1" style="font-size:10px;">ON ALL BOOKINGS</h></li>      
                          <li><img width="40" src="assets/images/tik.png"><p id="p2">BEST RATE </br><h id="h2" style="font-size:10px;">GUARANTEE</h></li>
                        <li><img width="40" src="assets/images/location.png"><p id="p3">LOCATION </br><h id="h3" style="font-size:30px;">HA NOI</h></li>
                    </ul>
                </div>
            </div>
        </div>
